...
object HoleInTheWall : Handler {
    ...
    override fun update() {
        ...
        val tabListPlayerIndexes: List<Pair<Int, Int>> = listOf(
            0 to 20,
            1 to 21,
            2 to 22,
            3 to 23,
        ...
        tabListPlayerIndexes.forEach {
            val usernameIndex = it.first
            val scoreIndex = it.second
            ...
            val score = Regex("(?<score>\\b\\d+\\b)").find(tabList[scoreIndex].tabListDisplayName?.string ?: "")
